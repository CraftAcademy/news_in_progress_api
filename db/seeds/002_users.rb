...
User.create(name: 'Fraser Hughes', email: 'fraser@nip.com', role: 3, password: "password", password_confirmation: "password")
User.create(name: 'Matthew Henry', email: 'matthew@nip.com', role: 2, password: "password", password_confirmation: "password")
